...
extern void UART_SendInt(int32_t num);
extern void UART_SendInt0(int32_t num);
extern void UART_SendHex8(uint16_t num);
extern void UART_SendHex16(uint16_t num);
extern void UART_SendHex32(uint32_t num);

extern void UART_SendStr(char *str);

extern void UART_SendBuf(char *buf, uint16_t bufsize);
extern void UART_SendBufPrintable(char *buf, uint16_t bufsize, char subst);
extern void UART_SendBufHex(char *buf, uint16_t bufsize);
extern void UART_SendBufHexFancy(char *buf, uint16_t bufsize, uint8_t column_width, char subst);
